 ...
 */
export default function TaskForm({ initialData = null, onSubmit, onCancel, groupMembers = [] }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await onSubmit?.({
        ...
        assignees: groupMembers.filter(m => form.assigneeIds.includes(m.uid)),
      });
    } finally {
      setSubmitting(false);
    }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div>
        ...
        <input
          ...
          onFocus={e => e.target.style.borderColor = "#3b82f6"}
          onBlur={e => e.target.style.borderColor = errors.deadline ? "#ef4444" : "#e5e7eb"}
        />
              ...
              return (
                <button key={member.uid}
                  ...
                  style={{
                    ...
                    fontSize: "13px", cursor: "pointer", fontWeight: selected ? 600 : 400,
      ...
      <div style={{ display: "flex", gap: 10, justifyContent: "flex-end", paddingTop: 4 }}>
        ...
        <button onClick={handleSubmit} disabled={submitting}
          style={{
            ...
            color: "#fff", fontSize: "14px", cursor: submitting ? "not-allowed" : "pointer",
